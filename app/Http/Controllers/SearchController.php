...
class SearchController extends Controller
{
    ...
    return view('superadmin.recherche.annance' , compact('annanceur','natures','rubriques','versions','list_offres_finale'));
      ...
      public function search(Request $request) 
    {
       ...
       return view('superadmin.recherche.annance' , [
 ...
 public function detail($id)
    {
        ...
        return view('superadmin.recherche.detail', compact('data'));   
    }
